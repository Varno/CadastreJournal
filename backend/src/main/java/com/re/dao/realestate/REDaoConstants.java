...
public interface REDaoConstants {
    public static final String FACILITY_ID = "FACILITY_ID";
    public static final String CADASTRAL_NUMBER = "CADASTRAL_NUMBER";
    ...
    public static final String MODIFIED_BY_IP     = "MODIFIED_BY_IP";
    ...
    public static final String P_CADASTRAL_NUMBER ="p_cadastral_number";
